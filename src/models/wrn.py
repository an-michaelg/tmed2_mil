...
class WideResNet(nn.Module):
    ...
    def forward(self, x, ood_test=False):
        ...
        out = F.adaptive_avg_pool2d(out, 1) # TODO Ask Neda which wrn she used
...
class build_WideResNet:
    def __init__(self, first_stride=1, depth=28, widen_factor=2, drop_rate=0.0):
...
if __name__ == '__main__':
    wrn_builder = build_WideResNet(1, 28, 2, 0.5)
    wrn = wrn_builder.build(128)
    #print(wrn)
    r = 112
    test_in = torch.randn((4, 3, r, r))
    test_out = wrn(test_in)
